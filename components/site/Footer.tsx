      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/join" className="text-gray-300 hover:text-white transition">Join Community</Link></li>
              <li><Link href="/stories" className="text-gray-300 hover:text-white transition">Thriver Stories</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/volunteer" className="text-gray-300 hover:text-white transition">Volunteer</Link></li>
              <li><Link href="/partnerships" className="text-gray-300 hover:text-white transition">Partnerships</Link></li>
              <li><Link href="/corporate" className="text-gray-300 hover:text-white transition">Corporate Giving</Link></li>
            </ul>
          </div>
